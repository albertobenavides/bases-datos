...
# 
# Una representación meramente didáctica con estos elementos puede verse en la figura {numref}`fig:e-r:grafico`.
# 
...
# 
# ### Instrucciones
# 1. [9 puntos] Convierte tu base de datos no estructurada en un modelo entidad-relación, representándolo con un diagrama entidad-relación. Usa nodos con figuras correctas y aristas claramente señaladas con los números correspondientes para las relaciones.
# 1. [1 punto] Subir esta descripción en un archivo `markdown` o `PDF` nombrado claramente (tarea 1 o algo por el estilo).
# :::
# 
# ### Ejemplo
# 
